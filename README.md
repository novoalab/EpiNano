...
Major differences with EpiNano 1.0: (i) Faster! (ii) Uses python3 instead of python2 (iii) Does not extract current intensity in the feature table, as this feature was not used to train the final models.
