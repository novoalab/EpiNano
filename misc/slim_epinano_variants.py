...
desc="""
    This script is created to replace the original Epinano_Variants.py, which relies 3rd party software such as sam2tsv.jar.
    Dependencies: pysam 
"""

epilog = """Author: Huanle Liu (huanle.liu@uqconnect.edu.au)
Suzhou, 20/05/2023
"""
